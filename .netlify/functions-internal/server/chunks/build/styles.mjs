...
const styles = {
  "pages/index.vue": () => import('./index-styles.CCRrP9TF.mjs').then(interopDefault),
  ...
  "pages/index.vue?vue&type=style&index=0&lang.css": () => import('./index-styles.CCRrP9TF.mjs').then(interopDefault),
