...
const matcher = /* @__PURE__ */ (() => {
  const $0 = { payload: false, prerender: false };
  return (m, p) => {
    let r = [];
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-tPOnTDbR.mjs')
  },
  {
    name: "work",
    path: "/work",
    component: () => import('./index-D1X2of2L.mjs')
  },
  {
    name: "work-slug",
    path: "/work/:slug()",
    component: () => import('./_slug_-B001qTEn.mjs')
  }
];
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "relative h-screen w-full" }, _attrs))}>`);
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-CGMI_ZbX.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-DIOsh8lG.mjs'));
...
export { _export_sfc as _, useNuxtApp as a, useRouter as b, useRuntimeConfig as c, nuxtLinkDefaults as d, entry_default as default, encodeRoutePath as e, navigateTo as n, resolveRouteObject as r, useRoute as u };
