...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "cba50446-2696-4028-989b-a6f7af23a208",
...
const _lazy_UXyzBd = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_UXyzBd, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_UXyzBd, lazy: true, middleware: false, method: undefined }
];
